...
export function ChevronPrevIcon({ className }: IconProps) {
  return (
    <svg className={className} data-dir-flip="" width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
...
export function FlagIlIcon({ className }: IconProps) {
  return (
    <svg className={className} width="20" height="14" viewBox="0 0 20 14" aria-hidden="true">
      <rect width="20" height="14" rx="2" fill="#fff" />
      <rect y="2.1" width="20" height="1.9" fill="#0038B8" />
      <rect y="10" width="20" height="1.9" fill="#0038B8" />
      <path
        d="M10 4.3 12.35 8.4H7.65zM10 9.8 7.65 5.7h4.7z"
        fill="none"
        stroke="#0038B8"
        strokeWidth="0.85"
        strokeLinejoin="round"
      />
      <rect x="0.35" y="0.35" width="19.3" height="13.3" rx="1.75" fill="none" stroke="rgba(11,18,48,.18)" strokeWidth="0.7" />
    </svg>
  )
}
...
export function FlagUsIcon({ className }: IconProps) {
  return (
    <svg className={className} width="20" height="14" viewBox="0 0 20 14" aria-hidden="true">
      ...
      <rect width="8.6" height="6" fill="#3C3B6E" />
      <g fill="#fff">
        <circle cx="2" cy="1.6" r="0.5" />
        <circle cx="4.3" cy="1.6" r="0.5" />
        <circle cx="6.6" cy="1.6" r="0.5" />
        <circle cx="3.15" cy="3" r="0.5" />
        <circle cx="5.45" cy="3" r="0.5" />
        <circle cx="2" cy="4.4" r="0.5" />
        <circle cx="4.3" cy="4.4" r="0.5" />
        <circle cx="6.6" cy="4.4" r="0.5" />
      </g>
      <rect x="0.35" y="0.35" width="19.3" height="13.3" rx="1.75" fill="none" stroke="rgba(11,18,48,.18)" strokeWidth="0.7" />
    </svg>
  )
