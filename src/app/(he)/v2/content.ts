    ...
    faqEntries: [
      {
        ...
        answer:
          'המחיר נגזר מסוג הפרויקט ומההיקף שלו: דף נחיתה ממוקד, אתר תדמית לפי מספר העמודים, או חנות ומערכת מותאמת אישית שמתומחרות לפי המורכבות. אחרי שיחת אפיון קצרה תקבלו הצעת מחיר שקופה עם פירוט מה כלול ומה לא, בלי עלויות שמתגלות באמצע הדרך.',
      },
      {
        question: 'כמה זמן לוקח לבנות אתר?',
        answer:
          'דף נחיתה עולה לאוויר תוך שבועות בודדים, אתר תדמית מלא לוקח בדרך כלל בין חודש לחודשיים, וחנות או מערכת מותאמת אישית - יותר מכך. הגורם שהכי מאריך לוח זמנים הוא בדרך כלל התוכן והתמונות, ולכן אנחנו מגדירים אותם כבר באפיון.',
      },
      {
        question: 'וורדפרס או אתר בקוד - מה עדיף לעסק שלנו?',
        answer:
          'תלוי במה שהאתר צריך לעשות. לאתר תוכן פשוט שמתעדכן הרבה, וורדפרס יכול להספיק. כשצריך ביצועים גבוהים, לוגיקה עסקית ייחודית או אינטגרציות למערכות קיימות, פיתוח בקוד יוצא זול יותר לאורך זמן כי לא משלמים על עקיפת מגבלות. באפיון נגיד לכם בכנות מה מתאים, גם אם התשובה היא שלא צריך פיתוח מותאם.',
      },
      {
        question: 'האם הקוד של האתר שייך לנו?',
        answer:
          'כן. בסיום הפרויקט אתם מקבלים בעלות מלאה על הקוד ואת הגישה לדומיין, לאחסון ולכל השירותים המחוברים. אנחנו לא מחזיקים לקוחות דרך נעילה טכנית - אם תרצו להמשיך עם ספק אחר, המעבר אפשרי ומסודר.',
      },
      {
        question: 'האם האתר יהיה נגיש לפי התקן הישראלי?',
        answer:
          'כן. אנחנו בונים לפי התקן הישראלי 5568 התואם WCAG 2.0 ברמה AA: ניווט מלא במקלדת, ניגודיות תקינה, תמיכה בקוראי מסך והצהרת נגישות. נגישות היא חובה חוקית בישראל, ותוסף נגישות לבדו לרוב לא מספיק כדי לעמוד בה.',
      },
      {
        question: 'יש לנו אתר קיים - לשדרג אותו או לבנות מחדש?',
        answer:
          'באפיון נבדוק מה שווה לשמר: תוכן, כתובות קיימות ודירוגים אורגניים. אם בונים מחדש, אנחנו מתכננים מראש מפת הפניות 301 כדי לא לאבד את הקידום שכבר השגתם. מעבר לא מתוכנן מאתר ותיק הוא אחת הדרכים המהירות ביותר למחוק שנים של עבודה אורגנית.',
      },
    ],
  },
  ecommerce: {
    ...
    faqEntries: [
      {
        ...
        answer:
          'סימנים ראשונים - שיפור באינדוקס ובמיקומים של ביטויים פחות תחרותיים - מופיעים בדרך כלל אחרי שניים עד ארבעה חודשים. תוצאות משמעותיות בביטויים תחרותיים לוקחות לרוב שישה חודשים ומעלה. אתר חדש לגמרי מתחיל לאט יותר מאתר ותיק עם היסטוריה בגוגל.',
      },
      {
        question: 'כמה עולה קידום אתרים בחודש?',
        answer:
          'המחיר תלוי ברמת התחרות בתחום, במצב הטכני של האתר ובהיקף התוכן שצריך לייצר. אחרי בדיקה ראשונית נציג לכם טווח מחיר ברור עם פירוט מה נכלל בכל חודש - מחקר, עבודה טכנית, תוכן וקישורים - כדי שתדעו על מה בדיוק אתם משלמים.',
      },
      {
        question: 'מה ההבדל בין קידום אורגני לקידום ממומן?',
        answer:
          'קמפיין ממומן מביא תנועה מהיום הראשון ונעצר ברגע שנגמר התקציב. קידום אורגני לוקח חודשים אבל ממשיך לייצר פניות גם אחרי שמפסיקים להשקיע. ברוב העסקים השילוב עובד הכי טוב: ממומן לטווח הקצר, אורגני כנכס שנבנה לאורך זמן.',
      },
      {
        question: 'אתם מבטיחים מקום ראשון בגוגל?',
        answer:
          'לא, ואף אחד לא באמת יכול. גוגל לא מוכר מיקומים אורגניים ומעדכן את האלגוריתם שלו כל הזמן. מה שכן אפשר להתחייב אליו זה תוכנית עבודה ברורה, שקיפות מלאה על מה נעשה בכל חודש, ומדידה של הפניות בפועל. הבטחה למקום ראשון היא דגל אדום.',
      },
      {
        question: 'איך גורמים לאתר שלנו להופיע בתשובות של ChatGPT ובסקירות AI של גוגל?',
        answer:
          'זה תחום שנקרא GEO - אופטימיזציה למנועי חיפוש גנרטיביים. בפועל זה דורש תוכן שעונה תשובות ישירות וברורות, נתונים מובנים תקינים, סמכות ואזכורים במקורות אחרים, וגישה פתוחה לסורקים של מנועי ה-AI. אנחנו מטפלים בזה כחלק מהשירות, כי חלק גדל מהחיפושים כבר לא מסתיים בקליק לאתר.',
      },
      {
        question: 'אנחנו עסק מקומי. אתם עושים גם קידום מקומי?',
        answer:
          'כן. לעסק שנותן שירות באזור מסוים, הפרופיל העסקי בגוגל והתוצאות המקומיות חשובים לא פחות מהאתר. אנחנו מטפלים בכרטיס העסק, בביקורות, בעמודי שירות לפי אזור ובאזכורים מקומיים, כדי שתופיעו למי שמחפש בקרבת מקום.',
      },
      {
        question: 'האתר שלנו נבנה אצל ספק אחר. אפשר לקדם אותו?',
        answer:
          'כן, ואנחנו עושים את זה הרבה. נתחיל בבדיקה טכנית שתראה מה חוסם את הקידום במצב הקיים. חלק מהתיקונים אפשר לבצע גם באתר שלא בנינו; אם נגלה חסם מבני שלא ניתן לעקוף, נגיד לכם את זה מראש במקום לגבות חודשים על עבודה שלא תוכל להניב תוצאה.',
      },
    ],
  },
  brochure: {
    ...
    faqEntries: [
      {
        ...
        answer:
          'בשוק הישראלי הטווח נע בערך בין 190 ל-690 ₪ לחודש לאתר תדמית, ועולה לחנויות ולמערכות. אצלנו חבילת הבסיס היא 290 ₪ לחודש והחבילה העסקית 590 ₪ לחודש, בהתחייבות שנתית. חנויות ומערכות מתומחרות לפי היקף. פירוט מלא של העלויות לאורך שנה נמצא במדריך שלנו על עלות תחזוקת אתר.',
      },
      {
        question: 'מה כולל שירות תחזוקת אתרים ומה לא?',
        answer:
          'כלול: עדכוני ליבה ותוספים, גיבוי יומי, ניטור זמינות, תיקון תקלות ושינויי תוכן לפי מכסת שעות. לא כלול: פיתוח פיצ׳רים חדשים, עיצוב מחדש של עמודים, כתיבת תוכן שיווקי וניהול קמפיינים. את אלה אנחנו מתמחרים בנפרד, כדי שלא תשלמו חודש-חודש על מה שלא צורכים.',
      },
      {
        question: 'אתם מתחזקים אתרים שלא בניתם?',
        answer:
          'כן, וזה חלק גדול מהעבודה. מתחילים במיפוי: על מה האתר בנוי, אילו גרסאות רצות, מה מצב הגיבויים ומה שבור. אחר כך משיגים גישות, מתעדים ומסדירים בעלות על הדומיין והאחסון — במיוחד במקרים שבהם המפתח הקודם נעלם ואין גישה לקוד.',
      },
      {
        question: 'מה זמני התגובה בפועל?',
        answer:
          'בחבילת הבסיס: עד 24 שעות עסקים. בחבילה העסקית: עד 4 שעות עסקים. תקלה שמפילה את האתר לגמרי מטופלת בעדיפות עליונה בכל החבילות. זמני התגובה והתיקון כתובים בהסכם, ולא נשארים כהבטחה בעל פה.',
      },
      {
        question: 'האם תחזוקה כוללת נגישות לפי ת"י 5568?',
        answer:
          'בחבילה העסקית ומעלה — כן, בדיקה רבעונית. זה חשוב כי נגישות אינה מצב קבוע: כל הוספת תמונה בלי טקסט חלופי או שינוי צבע בכפתור יכולים לשבור התאמה שכבר הושגה. אודיט חד-פעמי מראה תמונת מצב ליום שבו הוא בוצע בלבד.',
      },
      {
        question: 'מה קורה לאינטגרציות כשספק משנה API?',
        answer:
          'זו אחת התקלות השקטות והיקרות ביותר: החיבור לחשבונית ירוקה, ל-iCount או לסליקה מפסיק לעבוד, וההזמנות ממשיכות להיכנס בלי שנוצרת חשבונית. בחבילה העסקית תחזוקת האינטגרציות כלולה, כולל תיקון כשספק משנה ממשק.',
      },
      {
        question: 'אפשר לעצור את החוזה?',
        answer:
          'החבילות הן בהתחייבות שנתית, כי תחזוקה נמדדת לאורך זמן ולא בחודש בודד. בסיום התקופה אפשר לא לחדש, ואתם מקבלים את כל הגישות, הגיבויים והתיעוד — האתר שלכם, גם אם נפרדנו.',
      },
    ],
  },
}
