    ...
    faqEntries: [
      {
        ...
        answer:
          'בשוק הישראלי הטווח נע בערך בין 190 ל-690 ₪ לחודש לאתר תדמית, ועולה לחנויות ולמערכות מותאמות אישית. אצלנו חבילת הבסיס היא 290 ₪ לחודש והחבילה העסקית 590 ₪ לחודש, שתיהן בהתחייבות שנתית; חנויות ומערכות מתומחרות לפי היקף. הסכומים האלה קונים מחזור מוגדר של עדכונים, גיבוי יומי מחוץ לשרת, ניטור זמינות וזמן תגובה כתוב בהסכם - ולא הבטחה כללית לזמינות. כדאי לזכור שתחזוקה היא רק חלק מעלות ההחזקה השנתית: לצידה יש אחסון, דומיין, תעודת SSL ולעיתים רישיונות. פירוט מלא של כל אלה לאורך שנה נמצא במדריך שלנו על עלות תחזוקת אתר.',
      },
      {
