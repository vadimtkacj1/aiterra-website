          ...
          <div className="max-w-3xl">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-5 mb-6 shadow-sm">
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-[14px] text-[#111827] focus:outline-none focus:border-[#2447D6]"
              />
            </div>
              ...
              {currentData.items.map((item, i) => (
                <div key={i} className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-[14px] text-[#111827] focus:outline-none focus:border-[#2447D6] mb-3"
                  />
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-[14px] text-[#111827] focus:outline-none focus:border-[#2447D6] resize-y"
                  />
                </div>
              ))}
            </div>
            ...
            <div className="flex gap-3">
              <button
                onClick={addItem}
                className="px-4 py-2 text-[13px] font-semibold text-[#2447D6] border border-[#2447D6]/40 rounded-lg hover:bg-[#2447D6]/5 transition-colors"
              >
                + הוספת שאלה
              </button>
              <button
