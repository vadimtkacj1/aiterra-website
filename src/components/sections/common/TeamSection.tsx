      ...
      <div className="max-w-7xl mx-auto px-0 md:px-6">
        <div className="text-right mb-16 px-6 md:px-0">
          ...
          >
            ...
            <p>
               ב-AITERRA, אנחנו מאמינים שהטכנולוגיה הכי טובה בעולם לא שווה הרבה בלי האנשים הנכונים שמפעילים אותה. לכן, הרכבנו {'"'}סיירת דיגיטלית{'"'} ממוקדת-מטרה, המשלבת יכולות פיתוח עמוקות יחד עם אסטרטגיות שיווק ולידים אגרסיביות. כל אחד מאיתנו חי ונושם את תחום המומחיות שלו, ויחד – אנחנו המנוע שדוחף את העסק שלכם למקסימום חשיפה, המרות וצמיחה.
            </p>
          </div>
        </div>
