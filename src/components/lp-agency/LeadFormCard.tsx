...
import { submitShortLeadForm } from '@/lib/lp-agency-leads'
...
export default function LeadFormCard() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : "לא הצלחנו לשלוח את הטופס. נסו שוב, או התקשרו אלינו.";
