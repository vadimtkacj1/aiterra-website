import { SERVICES } from '@/lib/lp-agency-content'
import type { Service } from '@/lib/lp-agency-types'
import Image from "next/image";

type ServicesProps = { heading?: string; items?: Service[] }

export default function Services({ heading = 'השירותים שלנו', items = SERVICES }: ServicesProps) {
