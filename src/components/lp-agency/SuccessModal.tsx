...
export default function SuccessModal({ isOpen, onClose, variant = 'light' }: SuccessModalProps) {
  ...
  const lightContent = {
    ...
    description: 'קיבלנו את הפרטים. נחזור אליכם תוך יום עסקים עם כיוון ראשוני מותאם לעסק שלכם.',
    buttonText: 'סגירה'
  };

  const darkContent = {
    title: 'מעולה! אנחנו יוצאים לדרך',
    description: 'איש צוות יחזור אליכם כדי לבנות מסלול צמיחה מותאם לעסק שלכם.',
    buttonText: 'סגור'
  };
